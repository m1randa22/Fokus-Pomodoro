...
const btnDeletearConcluidas= document.querySelector('#btn-remover-concluidas')
...
function createTask(tarefa) {
    ...
    li.appendChild(svgIcon) //colocando o elemento filho para dentro do elemento pai
...
btnDeletearConcluidas.addEventListener('click', () => removerTarefas(true))
